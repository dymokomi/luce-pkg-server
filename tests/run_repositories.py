...
def main():
    ...
    parser.add_argument('--fixture', choices=['repositories', 'refs', 'large_objects', 'graph', 'receive', 'releases', 'pull_requests'], default='repositories')
    ...
    for name, flags in modes.items():
        ...
        with tempfile.TemporaryDirectory(prefix='repo-', dir='/tmp') as temporary:
            ...
            elif args.fixture not in ('graph', 'receive'):
